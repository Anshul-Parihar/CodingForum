...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  ...
  if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']){
    ...
    <button type="button" class="btn btn-success ml-2" disabled>Welcome '.$_SESSION['useremail'].'</button>
    <a href="partials/_logout.php" class="btn btn-outline-success ml-2 my-sm-0">Logout</a>
  </form>';
  }
  else{
    echo '<form class="form-inline my-2 my-lg-0" action="search.php" method="get">
    ...
    <button class="btn btn-outline-success ml-2 my-sm-0" data-toggle="modal" data-target="#loginModal" >Login</button>
...
if(isset($_GET["signupsuccess"]) && $_GET["signupsuccess"]=="true"){
  ...
  <strong>success!</strong> You can login now using registerd email.
